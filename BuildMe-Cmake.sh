...
autobuild  configure -c ReleaseOS -- cmake  -DLL_TESTS:BOOL=OFF -USESYSTEMLIBS:BOOL=ON -DWORD_SIZE=64  \
...
pause 'Press [Enter] key to install the viewer  or ctrl c to stop...'
# rest of the script
#
