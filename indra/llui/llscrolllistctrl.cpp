...
bool LLScrollListCtrl::highlightMatchingItems(const std::string& filter_str)
{
    ...
    setHighlightedColor(LLUIColorTable::instance().getColor("SearchableControlHighlightColor", LLColor4::orange4));
