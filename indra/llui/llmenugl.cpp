...
void LLMenuItemCallGL::onCommit( )
{
...
void LLMenuItemCallGL::updateEnabled( )
{
...
void LLMenuItemCallGL::updateVisible( )
{
...
void LLMenuItemCheckGL::onCommit( )
{
...
void LLMenuScrollItem::onCommit( )
{
	LLUICtrl::onCommit();
}
...
// called to rebuild the draw label
void LLContextMenuBranch::buildDrawLabel( )
{
	auto menu = getBranch();
	if (menu)
	{
...
void LLContextMenuBranch::onCommit( )
{
	showSubMenu();
