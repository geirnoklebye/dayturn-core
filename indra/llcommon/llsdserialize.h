...
public:
	 ...
	 */
	S32 parse(std::istream& istr, LLSD& data, ssize_t max_bytes, S32 max_depth = -1);
...
public:
	 ...
	 */
	static bool deserialize(LLSD& sd, std::istream& str, ssize_t max_bytes);
	...
	static S32 fromNotation(LLSD& sd, std::istream& str, ssize_t max_bytes)
	{
		LLPointer<LLSDNotationParser> p = new LLSDNotationParser;
		return p->parse(str, sd, max_bytes);
	}
	static LLSD fromNotation(std::istream& str, ssize_t max_bytes)
	{
		LLPointer<LLSDNotationParser> p = new LLSDNotationParser;
		LLSD sd;
...
//		return fromXMLDocument(sd, str, emit_errors);
	...
	static S32 fromBinary(LLSD& sd, std::istream& str, ssize_t max_bytes, S32 max_depth = -1)
	{
		LLPointer<LLSDBinaryParser> p = new LLSDBinaryParser;
		return p->parse(str, sd, max_bytes, max_depth);
	}
	static LLSD fromBinary(std::istream& str, ssize_t max_bytes, S32 max_depth = -1)
	{
		LLPointer<LLSDBinaryParser> p = new LLSDBinaryParser;
		LLSD sd;
