...
// static
bool LLSDSerialize::deserialize(LLSD& sd, std::istream& str, ssize_t max_bytes)
{
 ...
 */
int deserialize_string(std::istream& istr, std::string& value, ssize_t max_bytes);
...
S32 LLSDParser::parse(std::istream& istr, LLSD& data, ssize_t max_bytes, S32 max_depth)
{
