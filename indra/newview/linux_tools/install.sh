...
function homedir_install()
{
    ...
    warn "to install the Kokua64-USL Viewer in your home directory. If you"
    ...
    install_to_prefix "$HOME/.kokua64-USL-install"
    $HOME/.kokua64-install/etc/refresh_desktop_app_entry.sh
}

function root_install()
{
    local default_prefix="/opt/kokua64-USL-install"
