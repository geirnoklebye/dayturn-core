...
function homedir_install()
{
    ...
    warn "to install the Kokua-CEF Viewer in your home directory. If you"
    ...
    install_to_prefix "$HOME/.kokua-CEF-install"
    $HOME/.kokua-cef-install/etc/refresh_desktop_app_entry.sh
}

function root_install()
{
    local default_prefix="/opt/kokua-cef-install"
